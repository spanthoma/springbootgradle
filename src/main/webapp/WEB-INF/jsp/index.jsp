...
<html>
	<head>
		...
		<!--[if lte IE 8]><script src="<c:url value="/static/js/html5shiv.js"/>" type="text/javascript"></script><![endif]-->
		...
		<noscript>
			...
			<link rel="stylesheet" href="<c:url value="/css/style-desktop.css"/>" />
		</noscript>
	</head>
	<body class="homepage">
		...
		<div id="header">
			...
			<div id="menu-wrapper">
				<div class="container">
					<nav id="nav">
						<ul>
							<li class="active"><a href="<c:url value="/index"/>">Homepage</a></li>
		...
		<div id="main-wrapper">
			...
			<div id="banner">
				<div class="container">
					<div class="row">
						<section>
							<a href="#" class="image full"><img src="<c:url value="/images/pics01.jpg"/>" alt=""></a>
						</section>
					</div>
				</div>
			</div>
